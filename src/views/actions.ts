                    ...
                    ({
                        ...
                        permissionLevel:
                            (this._currentContext === 'user'
                                ...
                                : info.configuredWorkspacePermission) ??
                            info.configuredGlobalPermission ??
                            info.action.defaultPermission ??
                            PermissionLevel.OFF,
                        modifiedInCurrentContext:
                            (this._currentContext === 'workspace' &&
                                info.configuredWorkspacePermission !== undefined) ||
                        ...
                        modifiedExternally:
                            ...
                            (this._currentContext === 'workspace' &&
                                info.configuredWorkspacePermission === undefined &&
                                info.configuredGlobalPermission !== undefined) ||
                            ...
                            (info.configuredWorkspacePermission === undefined &&
                                info.configuredGlobalPermission === undefined &&
                                (info.action.defaultPermission ?? PermissionLevel.OFF) !== PermissionLevel.OFF),
        ...
        switch (message.type) {
            case 'viewToggledPermissions': {
                ...
                setPermissions(permissionUpdates, target).then(
                    () => {
                        if (this._currentContext === 'user') this.refreshActions();
                    },
                    erm => {
